...
`RESERVED_BINDING_NAMES` (14 SDK-owned, always present on every deploy):

```
ASSETS, PLATFORM_WORKER, API_WORKER, DEEPSPACE_APP_ID,
DEEPSPACE_RESOURCE_ID, DEEPSPACE_RELEASE_OPERATION_ID, APP_NAME,
OWNER_USER_ID, AUTH_JWT_PUBLIC_KEY, AUTH_JWT_ISSUER, AUTH_WORKER_URL,
